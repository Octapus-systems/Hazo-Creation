...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "HAZO Creations" },
      { name: "theme-color", content: "#0F0F10" },
      { property: "og:site_name", content: "HAZO Creations" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "HAZO Creations — Luxury Interior Design, Fit-Out & Smart Home Automation UAE" },
      { name: "twitter:title", content: "HAZO Creations — Luxury Interior Design, Fit-Out & Smart Home Automation UAE" },
      ...
      { name: "twitter:description", content: "Turnkey luxury interior design, fit-out and smart home automation across the UAE. Designing spaces. Engineering experiences." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700;900&family=Inter:wght@300;400;500;600&display=swap" },
